...
- Name: settings.spec.ts >> settings panel render (Tauri-stubbed) >> invoke shim resolves get_all_settings with fixture data
- Location: tests/e2e/settings.spec.ts:195:7
