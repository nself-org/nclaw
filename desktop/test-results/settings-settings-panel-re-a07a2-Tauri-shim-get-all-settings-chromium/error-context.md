...
- Name: settings.spec.ts >> settings panel render (Tauri-stubbed) >> provider setting accessible via Tauri shim get_all_settings
- Location: tests/e2e/settings.spec.ts:216:7
