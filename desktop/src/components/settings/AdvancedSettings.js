...
export function AdvancedSettings() {
    ...
    return (_jsxs("section", { "aria-labelledby": "advanced-heading", children: [_jsx("h2", { id: "advanced-heading", className: "text-lg font-semibold text-slate-100 mb-4", children: "Advanced" }), _jsxs("div", { className: "mb-5", children: [_jsx("label", { htmlFor: "log-level", className: "block text-sm font-medium text-slate-300 mb-1", children: "Log level" }), _jsx("p", { className: "text-xs text-slate-500 mb-2", children: "Controls verbosity of the local log file. Restart required for changes to take effect." }), _jsx("select", { id: "log-level", value: draft.log_level, onChange: (e) => setDraft((d) => ({
                        ...
                        })), className: "w-full rounded-md bg-slate-800 border border-slate-700 text-slate-100 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500", "aria-label": "Log level", children: LOG_LEVELS.map((l) => (_jsx("option", { value: l, children: l.charAt(0).toUpperCase() + l.slice(1) }, l))) })] }), _jsxs("div", { className: "space-y-4 mb-6", children: [_jsx(Toggle, { id: "toggle-telemetry", label: t('desktop.nclaw.telemetryLabel'), description: t('desktop.nclaw.telemetryDesc'), checked: draft.telemetry, onChange: (v) => setDraft((d) => ({ ...d, telemetry: v })) }), _jsx(Toggle, { id: "toggle-check-updates", label: t('desktop.nclaw.updatesLabel'), description: t('desktop.nclaw.updatesDesc'), checked: draft.check_updates, onChange: (v) => setDraft((d) => ({ ...d, check_updates: v })) })] }), error && (_jsx("p", { role: "alert", className: "mb-3 text-sm text-red-400", children: error })), _jsx("button", { onClick: handleSave, className: "rounded-md bg-sky-600 hover:bg-sky-500 text-white px-4 py-2 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-sky-500", "aria-label": t('save'), children: saved ? t('desktop.nclaw.saved') : t('save') })] }));
}
