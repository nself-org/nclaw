  ...
  return (
    ...
    >
      ...
      <Button
        ...
        className="absolute -right-3 top-4 z-10 h-6 w-6 rounded-full border border-gray-700 bg-gray-900 text-gray-400 shadow hover:bg-gray-800 hover:text-gray-200"
      >
        <svg
      ...
      {collapsed ? (
        ...
        <div className="flex flex-col items-center gap-2 pt-10 px-2">
          <Button
            ...
            className="rounded-md text-gray-400 hover:bg-gray-800 hover:text-sky-400"
          >
        ...
        <>
          ...
          <div className="flex-shrink-0 border-t border-gray-800 px-3 py-2">
            <Button
              variant="ghost"
              className="w-full justify-start gap-2 px-2 py-1.5 h-auto text-xs text-gray-500 hover:bg-gray-800 hover:text-gray-300"
            >
